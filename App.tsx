    ...
    return (
      <View style={{
        ...
        <Text style={{
          ...
          textAlign:'center',
          marginVertical: 40,
        }} adjustsFontSizeToFit>{item.text}</Text>
        <Button
        ...
        <NavigationContainer>
          <QueryClientProvider client={client}>
            <SafeAreaView style={styles.container}>
              ...
              <AppIntroSlider activeDotStyle={{backgroundColor: "#133279"}} ref={slider}  showNextButton={false}  bottomButton renderItem={renderItem} showDoneButton={false} data={slides} onDone={onDone}/>
              </>}
            </SafeAreaView>
          </QueryClientProvider>
        </NavigationContainer>
